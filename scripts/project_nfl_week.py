...
GAMES_PATH = PROJECT_ROOT / "data" / "nfl_upcoming_games.csv"
...
def build_edge(row: dict, ratings: dict[str, float]) -> dict | None:
    ...
    # Example:
    # Eagles -3.5 means market expects Eagles by 3.5.
    ...
    if edge_to_home > 0:
        ...
        # If home is -6.5, away side is +6.5.
        selection_market_line = -market_home_spread
    ...
    return {
        ...
        "signal_source": "NFL Spread Model v0",
